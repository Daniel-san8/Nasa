...
const TextPlanet = ({ textPlanet }: { textPlanet: textPlanet | null }) => {
  ...
  return (
    <div className="p-6 md:py-10 md:px-20">
      <div className="relative py-6 flex flex-col items-center after:content-[' '] after:w-5/6 after:h-0.5 after:absolute after:bottom-0 after:bg-barra-after after:opacity-25 md:after:w-11/12 lg:items-start">
      ...
      <div className="pt-6 md:flex md:justify-around lg:justify-start">
