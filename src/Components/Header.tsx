...
const Header = () => {
  return (
    <header className="flex items-center justify-between">
      ...
      <div className="hidden md:flex pl-24 pr-12 h-24 self-start  bg-white backdrop-filter bg-opacity-5 backdrop-blur-xl lg:hidden">
        <div className="font-barlow text-white tracking-widest self-center">
          <ul className="flex">
            <li>Home</li>
            <li>
